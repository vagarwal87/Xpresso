...
Agarwal V, Shendure J. [Predicting mRNA abundance directly from genomic sequence using deep convolutional neural networks](https://www.cell.com/cell-reports/pdf/S2211-1247(20)30616-1.pdf). 2020. **_Cell Reports_** 31 (7), 107663. [Youtube talk introducing the paper](https://youtu.be/xSdIJc-grXQ).
