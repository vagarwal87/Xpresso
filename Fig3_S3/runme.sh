...
# for y in {1..10}; do { for x in {0..9}; do { python deep_motif_learning_hyperopt.py --fold $y --trial $x test trials/tpe_1K_10epochs_optimized_0to20K.hyperopt pM10Kb_cv/ >pM10Kb_cv/fold$y\_trial$x.txt; } done } done &
# for y in {1..10}; do { for x in {0..9}; do { python deep_motif_learning_hyperopt.py --fold $y --trial $x test trials/tpe_1K_10epochs_optimized_0to20K.hyperopt pM10Kb_1KTest_K562expr_cv/ >pM10Kb_1KTest_K562expr_cv/fold$y\_trial$x.txt; } done } done &
# for y in {1..10}; do { for x in {0..9}; do { python deep_motif_learning_hyperopt.py --fold $y --trial $x test trials/tpe_1K_10epochs_optimized_0to20K.hyperopt pM10Kb_1KTest_GM12878expr_cv/ >pM10Kb_1KTest_GM12878expr_cv/fold$y\_trial$x.txt; } done } done &
# for y in {1..10}; do { for x in {0..9}; do { python deep_motif_learning_hyperopt.py --fold $y --trial $x test trials/tpe_1K_10epochs_optimized_0to20K.hyperopt pM10Kb_Mouse_cv/ >pM10Kb_Mouse_cv/fold$y\_trial$x.txt; } done } done &
# for y in {1..10}; do { for x in {0..9}; do { python deep_motif_learning_hyperopt.py --fold $y --trial $x test trials/tpe_1K_10epochs_optimized_0to20K.hyperopt pM10Kb_1KTest_mESCexpr_cv/ >pM10Kb_1KTest_mESCexpr_cv/fold$y\_trial$x.txt; } done } done &
